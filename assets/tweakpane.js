...
(function (global, factory) {
    ...
    function exportBladeState(superExport, thisState) {
        return Object.assign(Object.assign({}, superExport()), thisState);
    }
    ...
    class BladeController {
        ...
        importState(state) {
            return importBladeState(state, () => true, (p) => ({
    ...
    class LabeledValueController extends ValueBladeController {
        constructor(doc, config) {
            ...
            super(Object.assign(Object.assign({}, config), { value: config.value, view: new LabelView(doc, {
                    props: config.props,
                    viewProps: viewProps,
                }), viewProps: viewProps }));
    ...
    class BindingController extends LabeledValueController {
        constructor(doc, config) {
            super(doc, config);
            this.tag = config.tag;
        }
    ...
    class LabelBladeController extends BladeController {
        constructor(doc, config) {
            const viewProps = config.valueController.viewProps;
    ...
    class LabeledButtonController extends LabelBladeController {
        importState(state) {
            return importBladeState(state, (s) => super.importState(s), (p) => ({
    ...
    const VERSION$1 = new Semver('1.1.4');
    ...
    function isContainerBladeApi(api) {
    ...
    class ColorTextView {
        constructor(doc, config) {
            ...
            textsElem.classList.add(cn$a('w'));
            ...
            ccs.forEach((cs, index) => {
                connectValues({
                    ...
                    backward: (p, s) => {
                        ...
                        const c = createColor(appendAlphaComponent(removeAlphaComponent(comps), comps[3]), pickedMode, this.colorType_);
    ...
    const NumberInputPlugin = {
        ...
        controller: (args) => {
            ...
            const formatter = (_a = args.params.format) !== null && _a !== void 0 ? _a : createNumberFormatter(getSuitableDecimalDigits(c, value.rawValue));
    ...
    function getSuitableMax(initialValue, constraint) {
    ...
    function createInputBindingController(plugin, args) {
        ...
        return new InputBindingController(args.document, {
            blade: createBlade(),
            props: ValueMap.fromObject({
                label: (_a = params === null || params === void 0 ? void 0 : params.label) !== null && _a !== void 0 ? _a : args.target.key,
            }),
    ...
    function createMonitorBindingController(plugin, args) {
        ...
        return new BindingController(args.document, {
            blade: createBlade(),
            props: ValueMap.fromObject({
                label: (_c = params === null || params === void 0 ? void 0 : params.label) !== null && _c !== void 0 ? _c : args.target.key,
            }),
            value: value,
            valueController: controller,
        });
    ...
    class PluginPool {
        ...
        createInputBindingApi_(bc) {
            ...
            return api !== null && api !== void 0 ? api : new BindingApi(bc);
        }
    ...
    function findInputBindingValues(rack) {
        const vcs = rack.find(isInputBindingController);
        return vcs.map((vc) => vc.value);
    }
    function findMonitorBindingValues(rack) {
        return rack
    ...
    class RootApi extends FolderApi {
        ...
        refresh() {
            ...
            findInputBindingValues(this.controller_.rackController.rack).forEach((bv) => bv.fetch());
            // Force-read all monitor bindings
            findMonitorBindingValues(this.controller_.rackController.rack).forEach((mbv) => {
                mbv.fetch();
            });
        }
    }
